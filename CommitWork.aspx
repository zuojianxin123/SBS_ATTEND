<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CommitWork.aspx.cs" Inherits="CommitWork" %>
...
<div class="normalform" style="text-align:left; width:400px; margin-left:auto; margin-right:auto;">
    ...
    <h1>加班申报表</h1>
        ...
        <div class="item">
            <label class="lab">工作内容：</label>
          
            <asp:TextBox ID="tb_leave" runat="server" MaxLength="50" TextMode="MultiLine" 
                Width="261px" Height="164px">不得超过100字</asp:TextBox>
